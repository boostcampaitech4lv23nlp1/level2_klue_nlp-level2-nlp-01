...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', default='../dataset/train/binary_train.csv')
    parser.add_argument('--dev_path', default='../dataset/train/binary_val.csv')
    parser.add_argument('--test_path', default='../dataset/train/binary_val.csv')

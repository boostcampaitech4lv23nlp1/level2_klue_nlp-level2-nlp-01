...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', default='/opt/ml/dataset/train/multiple_train.csv')
    parser.add_argument('--dev_path', default='/opt/ml/dataset/train/multiple_val.csv')
    parser.add_argument('--test_path', default='/opt/ml/dataset/train/multiple_val.csv')

...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', default='/opt/ml/dataset/train/removed_paren_train.csv')
    parser.add_argument('--dev_path', default='/opt/ml/dataset/train/removed_paren_val_split.csv')
    parser.add_argument('--test_path', default='/opt/ml/dataset/train/removed_paren_val_split.csv')
